...
public class Start extends com.avaya.sce.runtime.Entry {
	...
	public com.avaya.sce.runtime.Submit getSubmit(com.avaya.sce.runtimecommon.SCESession mySession) {
		com.avaya.sce.runtime.Submit submit = new com.avaya.sce.runtime.Submit("CreditcardFetch");
		return ( submit );
	}
	/**
	...
	public void initializeVariables(com.avaya.sce.runtimecommon.SCESession session) {
		...
		variableFields = new String[] {
			IProjectVariables.CREDIT_CARD_LIST_MENU_FIELD_CONFIDENCE,
			IProjectVariables.CREDIT_CARD_LIST_MENU_FIELD_INPUTMODE,
			IProjectVariables.CREDIT_CARD_LIST_MENU_FIELD_INTERPRETATION,
			IProjectVariables.CREDIT_CARD_LIST_MENU_FIELD_NOINPUTCOUNT,
			IProjectVariables.CREDIT_CARD_LIST_MENU_FIELD_NOMATCHCOUNT,
			IProjectVariables.CREDIT_CARD_LIST_MENU_FIELD_UTTERANCE,
			IProjectVariables.CREDIT_CARD_LIST_MENU_FIELD_VALUE };
		variable = com.avaya.sce.runtime.ComplexVariable.createComplexVariable(IProjectVariables.CREDIT_CARD_LIST_MENU, variableFields, null, session, false, false );
		session.putVariable(variable);
		...
		variable = com.avaya.sce.runtime.SimpleVariable.createSimpleVariable(IProjectVariables.PAISA, "", null, session, false, false );
		session.putVariable(variable);

		variableFields = new String[] {
			IProjectVariables.PROMPT_FIELD_CREDIT_ACC,
			...
			IProjectVariables.PROMPT_FIELD_PROMPT___6,
			IProjectVariables.PROMPT_FIELD_UNTITLED_6 };
		...
		variableFields = new String[] {
			IProjectVariables.FLAG_FIELD_TRASNFER_VDN };
		...
		variableFields = new String[] {
			IProjectVariables.VARIABLES_FIELD_CREDIT_CARD_LIST,
			IProjectVariables.VARIABLES_FIELD_CREDIT_CARD_LIST_PROMPT,
			...
			IProjectVariables.VARIABLES_FIELD_PAGE_INDEX,
			IProjectVariables.VARIABLES_FIELD_PAGE_SIZE,
			IProjectVariables.VARIABLES_FIELD_PAISA,
			IProjectVariables.VARIABLES_FIELD_PRESS,
		...
		variableFields = new String[] {
			IProjectVariables.CREDIT_FIELD_AMOUNT,
			IProjectVariables.CREDIT_FIELD_BALANCE,
			IProjectVariables.CREDIT_FIELD_RUPEES,
			IProjectVariables.CREDIT_FIELD_UNTITLED_3 };
		variable = com.avaya.sce.runtime.ComplexVariable.createComplexVariable(IProjectVariables.CREDIT, variableFields, null, session, false, false );
		session.putVariable(variable);
		...
		variableFields = new String[] {
			...
			IProjectVariables.NODE_DETAILS_FIELD_PROMPT_COUNT };
		variable = com.avaya.sce.runtime.ComplexVariable.createComplexVariable(IProjectVariables.NODE_DETAILS, variableFields, null, session, false, false );
		session.putVariable(variable);

		variableFields = new String[] {
			IProjectVariables.ACCOUNT_NUMBER_FIELD_ACCOUNT_NUMBER___1,
			IProjectVariables.ACCOUNT_NUMBER_FIELD_ACCOUNT_NUMBER___2,
			IProjectVariables.ACCOUNT_NUMBER_FIELD_ACCOUNT_NUMBER___3,
			IProjectVariables.ACCOUNT_NUMBER_FIELD_ACCOUNT_NUMBER___4,
			IProjectVariables.ACCOUNT_NUMBER_FIELD_ACCOUNT_NUMBER___5,
			IProjectVariables.ACCOUNT_NUMBER_FIELD_BALANCE___1,
			IProjectVariables.ACCOUNT_NUMBER_FIELD_BALANCE___2,
			IProjectVariables.ACCOUNT_NUMBER_FIELD_BALANCE___3,
			IProjectVariables.ACCOUNT_NUMBER_FIELD_BALANCE___4,
			IProjectVariables.ACCOUNT_NUMBER_FIELD_PRESSCOUNT___1,
			IProjectVariables.ACCOUNT_NUMBER_FIELD_PRESSCOUNT___2,
			IProjectVariables.ACCOUNT_NUMBER_FIELD_PRESSCOUNT___3,
			IProjectVariables.ACCOUNT_NUMBER_FIELD_PRESSCOUNT___4,
			IProjectVariables.ACCOUNT_NUMBER_FIELD_PRESSCOUNT___5,
			IProjectVariables.ACCOUNT_NUMBER_FIELD_SELECTED___1,
			IProjectVariables.ACCOUNT_NUMBER_FIELD_SELECTED___2,
			IProjectVariables.ACCOUNT_NUMBER_FIELD_SELECTED___3,
			IProjectVariables.ACCOUNT_NUMBER_FIELD_SELECTED___4 };
		variable = com.avaya.sce.runtime.ComplexVariable.createComplexVariable(IProjectVariables.ACCOUNT_NUMBER, variableFields, null, session, false, false );
		session.putVariable(variable);
