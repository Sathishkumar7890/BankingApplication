 ...
 * Last generated by Orchestration Designer at: 2026-FEB-02  07:52:04 PM
 */
public class NRMN_IDENTIFICATION extends com.avaya.sce.runtime.Form {
	...
	public java.util.Collection getEvents(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		event = new com.avaya.sce.runtime.Event(com.avaya.sce.runtimecommon.SCERT.EVENT_NOINPUT, (com.avaya.sce.runtime.PromptRefInfo[])eventPromptNames.toArray(new com.avaya.sce.runtime.PromptRefInfo[0]), new com.avaya.sce.runtime.Goto("NRMN_Identification-NRMN_NINM", 0, true, ""));
		list.add(event);

		// Item has no prompts associated
		eventPromptNames = new java.util.ArrayList();

		event = new com.avaya.sce.runtime.Event(com.avaya.sce.runtimecommon.SCERT.EVENT_NOMATCH, (com.avaya.sce.runtime.PromptRefInfo[])eventPromptNames.toArray(new com.avaya.sce.runtime.PromptRefInfo[0]), new com.avaya.sce.runtime.Goto("NRMN_Identification-NRMN_NINM", 0, true, ""));
		list.add(event);
		return(list);
	}
	/**
	...
	public java.util.Collection getFields(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		grammarInfo.add(new com.avaya.sce.runtime.GrammarInfo("NRMNGrammarr", "1.0"));

		events = new java.util.ArrayList();
		properties = new java.util.ArrayList();

		nbest = 1;
		field = new com.avaya.sce.runtime.Field("NRMN_IDENTIFICATIONCopy", false, true, grammarInfo, promptNames, events, properties, nbest, false, false, com.avaya.sce.runtimecommon.SCERT.RECTARG_BODYTEXT_GEN);
		list.add(field);
	...
	public com.avaya.sce.runtime.Submit getSubmit(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		submit = new com.avaya.sce.runtime.Submit("NRMN_Identification-ValidateAccountNumber");
		return submit;
	}
	/**
	 ...
	 * by the code generator based on items in the call flow editor.
	 * This method should not be manually edited as changes may be
	 * overwritten by the code generator.  <br>Last generated by Orchestration Designer at: 2026-FEB-20  11:52:55 AM
	 */
	...
	public void requestBegin(SCESession mySession) {
		...
		mySession.getVariableField(IProjectVariables.CALL_HISTORY,IProjectVariables.CALL_HISTORY_FIELD_MENU_DESCRIPTION).setValue(current + " | NRMNIDENTIFICATION");
		mySession.getVariableField(IProjectVariables.CALL_HISTORY,IProjectVariables.CALL_HISTORY_FIELD_EXIT_LOCATION).setValue("NRMNIDENTIFICATION");
	}
	...
	public void updatePrompts(Collection prompts, SCESession mySession) {
		...
		for (int i = 0; i < menuPrompts.length(); i++) {
		    String SetPrompt = menuPrompts.getString(i);

		    TraceInfo.trace(ITraceInfo.TRACE_LEVEL_INFO,"NRMN IDENTIFICATION FLOW: " + SetPrompt,
		            mySession);
			mySession.getVariableField(IProjectVariables.PROMPT_URL,IProjectVariables.PROMPT_URL_FIELD_PROMPT_FULL_URL).setValue(SetPrompt);
	   ...
	   TraceInfo.trace(ITraceInfo.TRACE_LEVEL_INFO,"RMN_Flag : " + RMN_Flag,
		...
		try {
	        ...
	        String audioPath = mySession.getVariableField(IProjectVariables.PROMPT_URL, IProjectVariables.PROMPT_URL_FIELD_BASE_URL).getStringValue();
	        
	        TraceInfo.trace(ITraceInfo.TRACE_LEVEL_INFO,
	                "PromptFile " + audioPath, mySession);
	       
	        String NRMN = mySession.getVariableField(IProjectVariables.PROMPT_URL, IProjectVariables.PROMPT_URL_FIELD_PROMPT_FULL_URL).getStringValue();
	        String fullPromptPath = audioPath + NRMN;
	        
	       
	       TraceInfo.trace(ITraceInfo.TRACE_LEVEL_INFO,
	                "Before Set : " + NRMN, mySession);
	        ...
	        TraceInfo.trace(ITraceInfo.TRACE_LEVEL_INFO,
	                "Playing prompt : " + fullPromptPath, mySession);

	        mySession.getVariableField(IProjectVariables.PROMPT_URL, IProjectVariables.PROMPT_URL_FIELD_PROMPT_FULL_URL).setValue(fullPromptPath);
	        
	        String generalMsgAfter = mySession.getVariableField(IProjectVariables.PROMPT_URL, IProjectVariables.PROMPT_URL_FIELD_PROMPT_FULL_URL).getStringValue();
	        TraceInfo.trace(ITraceInfo.TRACE_LEVEL_INFO,
	                "NRMN_AfterSet : " + generalMsgAfter, mySession);
	        
	        prompt.add(1, new PhraseVariableElement("PromptURL:PromptFullURL", PhraseVariableElement.Type.AUDIO_URL));
	        prompts.add(prompt);

	    } catch (Exception e) {
	        TraceInfo.trace(ITraceInfo.TRACE_LEVEL_ERROR,
	                "Error in updatePrompts : " + e.getMessage(), mySession);
	    }
    }
  }
}
