...
public class Ann extends com.avaya.sce.runtime.Form {
	...
	public com.avaya.sce.runtime.Submit getSubmit(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		submit = new com.avaya.sce.runtime.Submit("ApiFail-Flag");
		return submit;
	}
	/**
	...
	public void updatePrompts(Collection prompts, SCESession mySession) {
	    ...
	    if(flag){
	    	...
	    	mySession.getVariableField(
		            IProjectVariables.VARIABELS,
		            IProjectVariables.VARIABELS_FIELD_NO_AGENT).setValue(true);
	    ...
	    boolean Noagent = mySession.getVariableField(
	            IProjectVariables.VARIABELS,
	            IProjectVariables.VARIABELS_FIELD_NO_AGENT
	    ).getBooleanValue();

	    TraceInfo.trace(ITraceInfo.TRACE_LEVEL_INFO,
                "NO Agent Flag " + Noagent, mySession);
	    // ⭐ VERY IMPORTANT
	    prompts.add(prompt);
	}
