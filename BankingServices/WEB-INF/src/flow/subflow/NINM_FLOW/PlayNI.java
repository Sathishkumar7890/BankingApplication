 ...
 * Last generated by Orchestration Designer at: 2026-FEB-12  11:53:32 AM
 */
public class PlayNI extends com.avaya.sce.runtime.Form {
	 ...
	 * by the code generator based on items in the call flow editor.
	 * This method should not be manually edited as changes may be
	 * overwritten by the code generator.  <br>Last generated by Orchestration Designer at: 2026-FEB-20  11:52:57 AM
	 */
	...
	public void updatePrompts(Collection prompts, SCESession mySession) {
		...
		mySession.getVariableField(IProjectVariables.SAV__OR__CUR__MENU, IProjectVariables.SAV__OR__CUR__MENU_FIELD_NOMATCHCOUNT).setValue(0);
		...
		try {
	       ...
	       TraceInfo.trace(ITraceInfo.TRACE_LEVEL_INFO,
	                "PROMPT NOINPUT SETTED : " + NOINPUT, mySession);
	       ...
	       TraceInfo.trace(ITraceInfo.TRACE_LEVEL_INFO,
	        ...
	        TraceInfo.trace(ITraceInfo.TRACE_LEVEL_INFO,
	                "NOINPUT PROMPT**** : " + fullPromptPath, mySession);
