 ...
 * Last generated by Orchestration Designer at: 2026-FEB-04  01:59:03 AM
 */
public class InvalidAccNumber extends com.avaya.sce.runtime.Form {
	...
	public com.avaya.sce.runtime.Submit getSubmit(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		submit = new com.avaya.sce.runtime.Submit("NRMN_Identification-NRMN_IDENTIFICATION");
		return submit;
	}
	/**
	...
	public void requestBegin(SCESession mySession) {
		...
		mySession.getVariableField(IProjectVariables.CALL_HISTORY,IProjectVariables.CALL_HISTORY_FIELD_MENU_DESCRIPTION).setValue(current + " | ACCNOINCORRECT");
		mySession.getVariableField(IProjectVariables.CALL_HISTORY,IProjectVariables.CALL_HISTORY_FIELD_EXIT_LOCATION).setValue("ACCNOINCORRECT");
	}
	...
	public void updatePrompts(Collection prompts, SCESession mySession) {
		...
		try {
	       ...
	       TraceInfo.trace(ITraceInfo.TRACE_LEVEL_INFO,
	                "PROMPT NOMATCH SETTED : " + NOMATCH, mySession);
	        
	        String fullPromptPath = audioPath + NOMATCH;
	        ...
	        String NM = mySession.getVariableField(IProjectVariables.PROMPT_URL, IProjectVariables.PROMPT_URL_FIELD_PROMPT_FULL_URL).getStringValue();
	        TraceInfo.trace(ITraceInfo.TRACE_LEVEL_INFO,
	                "AfterSet : " + NM, mySession);
