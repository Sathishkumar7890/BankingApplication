 ...
 * Last generated by Orchestration Designer at: 2026-FEB-02  12:14:05 PM
 */
public class Announce extends com.avaya.sce.runtime.Form {
	...
	public com.avaya.sce.runtime.Submit getSubmit(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		submit = new com.avaya.sce.runtime.Submit("GeneralMsg-FETCH_Node");
		return submit;
	}
	/**
	...
	public void updatePrompts(Collection prompts, SCESession mySession) {
		...
		try {
	       ...
	       String generalMsg = mySession.getVariableField(IProjectVariables.PROMPT_URL, IProjectVariables.PROMPT_URL_FIELD_PROMPT_FULL_URL).getStringValue();
	       TraceInfo.trace(ITraceInfo.TRACE_LEVEL_INFO,
	                "Before Set : " + generalMsg, mySession);
	        
	        String fullPromptPath = audioPath + generalMsg;
	        ...
	        TraceInfo.trace(ITraceInfo.TRACE_LEVEL_INFO,
	                "AfterSet : " + generalMsgAfter, mySession);
