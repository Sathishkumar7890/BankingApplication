 ...
 * Last generated by Orchestration Designer at: 2026-FEB-04  10:38:20 AM
 */
public class TPIN_AUTHENTICATION extends com.avaya.sce.runtime.Form {
	...
	public java.util.Collection getFields(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		grammarInfo.add(new com.avaya.sce.runtime.GrammarInfo("TPINGrammar", "1.0"));


		// build events for the field: "TPIN_AUTHENTICATION"
		events = new java.util.ArrayList(2);

		// Item has no prompts associated
		eventPromptNames = new java.util.ArrayList();

		event = new com.avaya.sce.runtime.Event(com.avaya.sce.runtimecommon.SCERT.EVENT_NOINPUT, (com.avaya.sce.runtime.PromptRefInfo[])eventPromptNames.toArray(new com.avaya.sce.runtime.PromptRefInfo[0]), new com.avaya.sce.runtime.Goto("TPIN_Authentication-setRetry", 0, true, ""));
		events.add(event);

		// Item has no prompts associated
		eventPromptNames = new java.util.ArrayList();

		event = new com.avaya.sce.runtime.Event(com.avaya.sce.runtimecommon.SCERT.EVENT_NOMATCH, (com.avaya.sce.runtime.PromptRefInfo[])eventPromptNames.toArray(new com.avaya.sce.runtime.PromptRefInfo[0]), new com.avaya.sce.runtime.Goto("TPIN_Authentication-setRetry", 0, true, ""));
		events.add(event);
		properties = new java.util.ArrayList();

		nbest = 1;
		field = new com.avaya.sce.runtime.Field("TPIN_AUTHENTICATION", false, true, grammarInfo, promptNames, events, properties, nbest, false, false, com.avaya.sce.runtimecommon.SCERT.RECTARG_BODYTEXT_GEN);
		list.add(field);
	...
	public com.avaya.sce.runtime.Submit getSubmit(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		submit = new com.avaya.sce.runtime.Submit("TPIN_Authentication-TpinAPI");
		return submit;
	}
	/**
	...
	public void requestBegin(SCESession mySession) {
		// TODO Auto-generated method stub
			...
			mySession.getVariableField(IProjectVariables.CALL_HISTORY,IProjectVariables.CALL_HISTORY_FIELD_MENU_DESCRIPTION).setValue(current + " | COLLECTTPIN");
			mySession.getVariableField(IProjectVariables.CALL_HISTORY,IProjectVariables.CALL_HISTORY_FIELD_EXIT_LOCATION).setValue("COLLECTTPIN_PC");
		}
	@Override
	public void updatePrompts(Collection prompts, SCESession mySession) {
		...
		try {
	        ...
	        TraceInfo.trace(ITraceInfo.TRACE_LEVEL_INFO,
	                "PromptFile URL " + audioPath, mySession);
	       
	        String TPIN = 
	    		    mySession.getVariableField(IProjectVariables.VARIABELS,IProjectVariables.VARIABELS_FIELD_TPIN).getStringValue();
	        String fullPromptPath = audioPath + TPIN;

	       TraceInfo.trace(ITraceInfo.TRACE_LEVEL_INFO,
	                "Before Set tpin prompt : " + TPIN, mySession);
	        ...
	        TraceInfo.trace(ITraceInfo.TRACE_LEVEL_INFO,
	                "TPI_AfterSet prompt : " + generalMsgAfter, mySession);
