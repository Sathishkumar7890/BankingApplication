 ...
 */
public class BankingServices1 extends com.avaya.sce.runtime.Invoke {
	...
	public String getWebAppEntryPoint(com.avaya.sce.runtimecommon.SCESession mySession) {
		String entryPoint = mySession.getParameter("module.BankingServices.entrypoint");
		if (entryPoint != null)
			return checkEntryPoint(entryPoint, mySession);
		return(checkEntryPoint("BankingServices/Start", mySession));
	}
	/**
