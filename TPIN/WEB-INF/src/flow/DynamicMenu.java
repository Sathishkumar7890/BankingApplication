 ...
 * Last generated by Orchestration Designer at: 2026-FEB-14  12:29:29 PM
 */
public class DynamicMenu extends com.avaya.sce.runtime.Menu {
	...
	public void requestBegin(SCESession mySession) {
		...
		mySession.getVariableField(IProjectVariables.CALL_HISTORY,IProjectVariables.CALL_HISTORY_FIELD_MENU_DESCRIPTION).setValue(current + " | PINSERVICEMENU");
		mySession.getVariableField(IProjectVariables.CALL_HISTORY,IProjectVariables.CALL_HISTORY_FIELD_EXIT_LOCATION).setValue("PINSERVICEMENU");
	...
	public void updateChoices(Collection choices, SCESession mySession) {
		...
		try {
			...
			for(int i=1;i<=MenuOptions;i++){
					...
					choice = new com.avaya.sce.runtime.Choice("DynamicMenu", Integer.toString(i), true, "exact", "ExitMenu", grammarInfo, true);
					choices.add(choice);
