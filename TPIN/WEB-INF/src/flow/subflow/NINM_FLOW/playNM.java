 ...
 */
public class playNM extends com.avaya.sce.runtime.Form {
	...
	public com.avaya.sce.runtime.Submit getSubmit(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		submit = new com.avaya.sce.runtime.Submit("NINM_FLOW-Repeat");
		return submit;
	}
	/**
...
//		mySession.getVariableField(IProjectVariables.SAV__OR__CUR__MEN, IProjectVariables.SAV__OR__CUR__MENU_FIELD_NOMATCHCOUNT).setValue(0);
//		mySession.getVariableField(IProjectVariables.SAV__OR__CUR__MENU, IProjectVariables.SAV__OR__CUR__MENU_FIELD_NOINPUTCOUNT).setValue(0);
		
		mySession.getVariableField(IProjectVariables.DYNAMIC_MENU, IProjectVariables.DYNAMIC_MENU_FIELD_NOINPUTCOUNT).setValue(0);
		mySession.getVariableField(IProjectVariables.DYNAMIC_MENU, IProjectVariables.DYNAMIC_MENU_FIELD_NOMATCHCOUNT).setValue(0);
		mySession.getVariableField(IProjectVariables.VARIABLES, IProjectVariables.VARIABLES_FIELD_EVENT_TYPE).setValue("");
//		
		...
		try {
	       ...
	       String NOINPUT = mySession.getVariableField(IProjectVariables.RETRY,IProjectVariables.RETRY_FIELD_NOMATCH).getStringValue();
	       TraceInfo.trace(ITraceInfo.TRACE_LEVEL_INFO,
	                "PROMPT NOMATCH SETTED : " + NOINPUT, mySession);
	       ...
	       TraceInfo.trace(ITraceInfo.TRACE_LEVEL_INFO,
	        ...
	        String fullPromptPath = audioPath + NOINPUT;

	        
	   
	        TraceInfo.trace(ITraceInfo.TRACE_LEVEL_INFO,
	                "NOMATCH PROMPT**** : " + fullPromptPath, mySession);
	       ...
	       // String NOMATCH = mySession.getVariableField(IProjectVariables.RETRY,IProjectVariables.RETRY_FIELD_NOMATCH).getStringValue();
	        ...
	        String NI = mySession.getVariableField(IProjectVariables.PROMPT_URL, IProjectVariables.PROMPT_URL_FIELD_PROMPT_FULL_URL).getStringValue();
	        TraceInfo.trace(ITraceInfo.TRACE_LEVEL_INFO,
	                "AfterSet : " + NI, mySession);
