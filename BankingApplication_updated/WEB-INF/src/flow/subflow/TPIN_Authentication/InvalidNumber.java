 ...
 * Last generated by Orchestration Designer at: 2026-FEB-04  03:35:13 PM
 */
public class InvalidNumber extends com.avaya.sce.runtime.Form {
	...
	public com.avaya.sce.runtime.Submit getSubmit(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		submit = new com.avaya.sce.runtime.Submit("TPIN_Authentication-TPIN_AUTHENTICATION");
		return submit;
	}
	/**
	 ...
	 * by the code generator based on items in the call flow editor.
	 * This method should not be manually edited as changes may be
	 * overwritten by the code generator.  <br>Last generated by Orchestration Designer at: 2026-FEB-15  08:16:49 PM
	 */
	...
	public void requestBegin(SCESession mySession) {
		...
		super.requestBegin(mySession);
		 TraceInfo.trace(ITraceInfo.TRACE_LEVEL_INFO, "TPIN INVALID: ", mySession);
	...
	public void updatePrompts(Collection prompts, SCESession mySession) {
		...
		try {
	        ...
	        String Invalid = mySession.getVariableField(IProjectVariables.RETRY,IProjectVariables.RETRY_FIELD_INVALID_NUMBER).getStringValue();
	       
	       TraceInfo.trace(ITraceInfo.TRACE_LEVEL_INFO,
	                "INVALID PROMPT SETTED : " + Invalid, mySession);
	        
	        String fullPromptPath = audioPath + Invalid;

	       // mySession.getVariableField(IProjectVariables.PROMPT_URL,IProjectVariables.PROMPT_URL_FIELD_BASE_URL).setValue(audioPath);
	   
	        TraceInfo.trace(ITraceInfo.TRACE_LEVEL_INFO,
	                "INVALID PROMPT**** : " + fullPromptPath, mySession);
