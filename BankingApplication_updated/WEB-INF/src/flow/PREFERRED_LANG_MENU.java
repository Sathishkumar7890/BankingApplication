 ...
 * Last generated by Orchestration Designer at: 2026-FEB-04  01:56:38 AM
 */
public class PREFERRED_LANG_MENU extends com.avaya.sce.runtime.Menu {
	 ...
	 * Last generated by Orchestration Designer at: 2026-FEB-06  03:22:43 PM
	...
	public java.util.Collection getEvents(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		event = new com.avaya.sce.runtime.Event(com.avaya.sce.runtimecommon.SCERT.EVENT_NOINPUT, (com.avaya.sce.runtime.PromptRefInfo[])eventPromptNames.toArray(new com.avaya.sce.runtime.PromptRefInfo[0]), new com.avaya.sce.runtime.Goto("End", 0, true, ""));
		list.add(event);

		// Item has no prompts associated
		eventPromptNames = new java.util.ArrayList();

		event = new com.avaya.sce.runtime.Event(com.avaya.sce.runtimecommon.SCERT.EVENT_NOMATCH, (com.avaya.sce.runtime.PromptRefInfo[])eventPromptNames.toArray(new com.avaya.sce.runtime.PromptRefInfo[0]), new com.avaya.sce.runtime.Goto("End", 0, true, ""));
		list.add(event);
		return(list);
	}
	/**
	...
	public java.util.Collection getChoices(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		choice = new com.avaya.sce.runtime.Choice("Options", "#90*", true, "exact", "ExitPreferredMenu", grammarInfo, true);
		list.add(choice);
	...
	public void updateChoices(Collection choices, SCESession mySession) {
		...
		try {
			...
			int MenuOptions = mySession.getVariableField(IProjectVariables.NODE_DETAILS,IProjectVariables.NODE_DETAILS_FIELD_DTMF).getIntValue();
			TraceInfo.trace(ITraceInfo.TRACE_LEVEL_INFO," DTMF : " + MenuOptions,mySession);
			
			int j = 0;
	
			for(int i=1;i<=MenuOptions;i++){

					choice = new com.avaya.sce.runtime.Choice("DynamicMenu", Integer.toString(i), true, "exact", "ExitPreferredMenu", grammarInfo, true);
					choices.add(choice);
