 ...
 * Last generated by Orchestration Designer at: 2026-FEB-03  10:28:06 AM
 */
public class PlayMax extends com.avaya.sce.runtime.Form {
	...
	public void updatePrompts(Collection prompts, SCESession mySession) {
		...
		try {
	       ...
	       TraceInfo.trace(ITraceInfo.TRACE_LEVEL_INFO,
	                "PROMPT MAXXX SETTED : " + MAX, mySession);
	        
	        String fullPromptPath = audioPath + MAX;

	       
	   
	        TraceInfo.trace(ITraceInfo.TRACE_LEVEL_INFO,
	                "MAXXX PROMPT**** : " + fullPromptPath, mySession);
	        ...
	        String MAX1 = mySession.getVariableField(IProjectVariables.PROMPT_URL, IProjectVariables.PROMPT_URL_FIELD_PROMPT_FULL_URL).getStringValue();
	        TraceInfo.trace(ITraceInfo.TRACE_LEVEL_INFO,
	                "AfterSet : " + MAX1, mySession);
