 ...
 * Last generated by Orchestration Designer at: 2026-FEB-07  06:01:05 PM
 */
public class SAV_OR_CUR_MENU extends com.avaya.sce.runtime.Menu {
	...
	public java.util.Collection getEvents(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		event = new com.avaya.sce.runtime.Event(com.avaya.sce.runtimecommon.SCERT.EVENT_NOINPUT, (com.avaya.sce.runtime.PromptRefInfo[])eventPromptNames.toArray(new com.avaya.sce.runtime.PromptRefInfo[0]), new com.avaya.sce.runtime.Goto("SetRetry", 0, true, ""));
		list.add(event);

		// Item has no prompts associated
		eventPromptNames = new java.util.ArrayList();

		event = new com.avaya.sce.runtime.Event(com.avaya.sce.runtimecommon.SCERT.EVENT_NOMATCH, (com.avaya.sce.runtime.PromptRefInfo[])eventPromptNames.toArray(new com.avaya.sce.runtime.PromptRefInfo[0]), new com.avaya.sce.runtime.Goto("SetRetry", 0, true, ""));
		list.add(event);
		return(list);
	}
	/**
	...
	public java.util.Collection getChoices(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		choice = new com.avaya.sce.runtime.Choice("SAV", "1", true, "exact", "ExitSavCurMenu", grammarInfo, true);
		list.add(choice);
		...
		choice = new com.avaya.sce.runtime.Choice("CUR", "2", true, "exact", "ExitSavCurMenu", grammarInfo, true);
		list.add(choice);
	...
	public void updatePrompts(Collection prompts, SCESession mySession) {
		String NextNode = mySession.getVariableField(IProjectVariables.NODE_DETAILS,IProjectVariables.NODE_DETAILS_FIELD_FETCH_NEXTNODE).getStringValue();
			TraceInfo.trace(ITraceInfo.TRACE_LEVEL_INFO,"******* SAV_OR_CUR_MENU *******",mySession);
			
			JSONObject nodeDetails = IVRFlow.getNodeByDescription("SAV_OR_CUR_MENU");
			...
			).setValue(totalPrompts);

			TraceInfo.trace(ITraceInfo.TRACE_LEVEL_INFO,
			        "TOTAL PROMPTS COUNT : " + totalPrompts,
			        mySession);
			...
			if (Noprompts != null) {
			    ...
			    for (int i = 0; i < totalPrompts; i++) {
			        ...
			        String promptValue = Noprompts.getString(i);   // ACC_ENDING_WITH.wav, PRESS.wav
			        String promptKey = "Prompt_" + (i + 1);       // Prompt_1, Prompt_2

			        mySession.getVariableField(IProjectVariables.PROMPT_URL,promptKey).setValue(promptValue);

			        TraceInfo.trace(ITraceInfo.TRACE_LEVEL_INFO,promptKey + " : " + promptValue,mySession);
			    }
			}
			...
			try {
				 Prompt prompt = new Prompt() {
					...
					for (int i = 1; i <= totalPrompts ; i++) {
			    		...
			    		prompt.add(1, new com.avaya.sce.runtime.PhraseVariableElement("PromptURL:Prompt_"+i, com.avaya.sce.runtime.PhraseVariableElement.Type.AUDIO_URL));				
				    }
