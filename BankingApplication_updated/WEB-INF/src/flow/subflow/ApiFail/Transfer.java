 ...
 * Last generated by Orchestration Designer at: 2026-FEB-18  02:40:36 AM
 */
public class Transfer extends com.avaya.sce.runtime.Form {
	...
	public java.util.Collection getProperties(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		property = new com.avaya.sce.runtime.Property("AVAYA_SIPHEADER.session.connection.protocol.sip.referto.header[0]", "Transfer", true, true);
		list.add(property);
	...
	public com.avaya.sce.runtime.Submit getSubmit(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		submit = new com.avaya.sce.runtime.Submit("ApiFail-ApiFAILED");
		return submit;
	}
	/**
