 ...
 * Last generated by Orchestration Designer at: 2026-FEB-02  06:46:14 PM
 */
public class FETCH_EMG_MSG extends com.avaya.sce.runtime.Data {
	...
	public com.avaya.sce.runtime.Next getNext(com.avaya.sce.runtimecommon.SCESession mySession) {
		com.avaya.sce.runtime.Next next = new com.avaya.sce.runtime.Next("GeneralMsg-CheckFlag", "Default");
		next.setDebugId(135);
		return next;
	}
	/**
	...
	public void requestBegin(SCESession mySession) {
	    super.requestBegin(mySession);	       
	            mySession.getVariableField(
		                ...
		                IProjectVariables.NODE_DETAILS_FIELD_FETCH_NEXTNODE).setValue("GENERAL_MSG");
			...
			if (menuDetails.get("nextNode") instanceof JSONArray) {
			    nextNode = menuDetails.getJSONArray("nextNode").getString(0);
			} else {
			    nextNode = menuDetails.getString("nextNode");
			}
			...
			for (int i = 0; i < menuPrompts.length(); i++) {
			    ...
			    TraceInfo.trace(ITraceInfo.TRACE_LEVEL_INFO,
			            "EMG IDENTIFICATION FLOW: " + prompt,
			            mySession);
