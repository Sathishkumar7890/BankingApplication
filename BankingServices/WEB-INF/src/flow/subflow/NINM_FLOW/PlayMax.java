 ...
 */
public class PlayMax extends com.avaya.sce.runtime.Form {
	...
	public com.avaya.sce.runtime.Submit getSubmit(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		submit = new com.avaya.sce.runtime.Submit("NINM_FLOW-Exceed");
		return submit;
	}
	/**
	...
	public void updatePrompts(Collection prompts, SCESession mySession) {
		 TraceInfo.trace(ITraceInfo.TRACE_LEVEL_INFO,"MAX***************************************",
	                mySession);
		...
		try {
	       ...
	       String NOINPUT = mySession.getVariableField(IProjectVariables.RETRY,IProjectVariables.RETRY_FIELD_MAX).getStringValue();
	       TraceInfo.trace(ITraceInfo.TRACE_LEVEL_INFO,
	                "PROMPT MAX SETTED : " + NOINPUT, mySession);
	       ...
	       TraceInfo.trace(ITraceInfo.TRACE_LEVEL_INFO,
	        ...
	        TraceInfo.trace(ITraceInfo.TRACE_LEVEL_INFO,
	                "MAX PROMPT**** : " + fullPromptPath, mySession);
