 ...
 * Last generated by Orchestration Designer at: 2026-FEB-08  07:17:05 PM
 */
public class AccountList extends com.avaya.sce.runtime.Menu {
	...
	public java.util.Collection getChoices(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		choice = new com.avaya.sce.runtime.Choice("Dynamic", "#90*", true, "exact", "End", grammarInfo, true);
		list.add(choice);
