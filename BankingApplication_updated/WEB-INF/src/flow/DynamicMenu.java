 ...
 * Last generated by Orchestration Designer at: 2026-FEB-01  08:35:45 PM
 */
public class DynamicMenu extends com.avaya.sce.runtime.Menu {
	...
	public java.util.Collection getChoices(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		choice = new com.avaya.sce.runtime.Choice("Dynamic", "#90*", true, "exact", "ExitMenu", grammarInfo, true);
		list.add(choice);
	...
	public void updateChoices(Collection choices, SCESession mySession) {
		...
		try {
			...
			for(int i=1;i<=MenuOptions;i++){
					...
					choice = new com.avaya.sce.runtime.Choice("DynamicMenu", Integer.toString(i), true, "exact", "ExitlLangMenu", grammarInfo, true);
					choices.add(choice);
